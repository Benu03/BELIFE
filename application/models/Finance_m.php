...
public function get_all_po_do_list_apv()
{
        ...
        $query = "SELECT 
                ...
                from po_do  a 
                left join po_do_type  b on a.po_do_type =b.id
                where a.status_po_do ='APV' and is_print=0 ORDER BY a.date_request desc";
...
public function get_all_list_file_upload()
{
    ...
    ,nama_file
    ,user_upload
    ,  convert(SmallDateTime,date_upload ) as date_upload
    ,is_posting
    ,user_posting
    ,    convert(SmallDateTime,date_posting ) as date_posting
        FROM billing_upload
...
public function get_data_upload_unposting()
{
        ...
        a.user_upload,
        convert(SmallDateTime, a.date_upload) as date_upload
