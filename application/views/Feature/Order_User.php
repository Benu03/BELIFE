            ...
            <div class="row">
              ...
              <div class="row no-print">
                <div class="col-12 ">
                  ...
                  <button type="submit" class="btn  btn-sm btn-success float-right"    id="btn_prosespesanan"
                  onclick="return confirm('Apakah data Pesanan anda sudah sesuai ?');"  ><i class="far fa-credit-card"></i> Proses Pesanan
                  </button>
                  </form>
