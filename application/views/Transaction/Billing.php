                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="card card-info">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form action="<?= base_url('Transaction/BillingUpload'); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card card-success">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php if ($checkposting == 1) : ?>
                                                ...
                                                <div class="form-group row">
                                                    <label for="kodepodo" class="col-sm-5 col-form-label">Jumlah Amount</label>
                                                    <label for="kodepodo" class="col-sm-5 col-form-label">Rp. <?= number_format($dataunposting['amount'], 0, ',', '.'); ?></label>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6 text-center">
                                                        <a href="javascript:void(0)" onclick="location.href='<?= base_url('Transaction/PostingBillingUpload'); ?>'" class="btn  btn-sm btn-warning  btn-block text-center"><i class="fas fa-check-double"></i> Posting Billing</a>
                                                    </div>
                                                    <div class="col-sm-6 text-center">

                                                        <a href="javascript:void(0)" onclick="location.href='<?= base_url('Transaction/ResetBillingUpload'); ?>'" class="btn  btn-sm btn-danger  btn-block text-center"><i class="fas fa-trash-restore-alt"></i> Reset Data Upload</a>
