...
<footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy;<?= date('Y'); ?> <a href="javascript:void(0)"> PT Betterlife Jaya Indonesia</a>.</strong> All rights reserved.
</footer>
</div>
<!-- ./wrapper -->
    ...
    $("#tblistpodo2").DataTable();
        ...
        function kalkulasi() {
            ...
            var totalharga = parseFloat(document.orderscustomer.totalharga.value);
                    ...
                    $.ajax({
                        ...
                        dataType : "JSON",
                        data : {tenor:tenor,totalharga:totalharga},
                        // cache: false,
                        success: function(data){
        ...
        function qty_subtotal(id) {
            ...
            var datasubtotal = qty * hrgbrg;
                    ...
                    document.getElementById("datasubtotal"+id).innerHTML =  rupiah(datasubtotal);   
                        ...
                        dataType : "JSON",
                        data : {id:id,qty:qty,hrgbrg:hrgbrg,kodeprd:kodeprd,datasubtotal:datasubtotal},
                        // cache: false,
                        success: function(data){
        ...
        var price = $(this).data('price');
                 ...
                 $.ajax({
                        ...
                        dataType : "JSON",
                        data : {kode_po_do:kode_po_do,kode_parent:kode_parent,price:price},
                        // cache: false,
                        success: function(data){
            ...
            function pododelorder(event) {
                        ...
                        var kode_po_do = $(this).data('kode_po_do');
                                ...
                                $.ajax({
                                        ...
                                        dataType : "JSON",
                                        data : {id:id,kode_po_do:kode_po_do},
                                        // cache: false,
                                        success: function(data){
        ...
        var noteapv =  $("#noteapv").val();  
                ...
                dataType : "JSON",
                data : {kode_po_do:kode_po_do,noteapv:noteapv},
                // cache: false,
                success: function(data){
