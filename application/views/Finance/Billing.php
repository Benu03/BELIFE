                                            ...
                                            <?php if ($checkposting == 1) : ?>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6 text-center">
                                                        <a href="javascript:void(0)" onclick="location.href='<?= base_url('Finance/PostingBillingUpload'); ?>'" class="btn  btn-sm btn-warning  btn-block text-center"><i class="fas fa-check-double"></i> Posting Billing</a>
                                                    </div>
                                                    <div class="col-sm-6 text-center">

                                                        <a href="javascript:void(0)" onclick="location.href='<?= base_url('Finance/ResetBillingUpload'); ?>'" class="btn  btn-sm btn-danger  btn-block text-center"><i class="fas fa-trash-restore-alt"></i> Reset Data Upload</a>
