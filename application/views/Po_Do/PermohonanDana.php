                         ...
                         <div class="row ">
                           ...
                           <div class="card card-solid">
                              ...
                              <div class="form-group row">
                                ...
                                <button type="button" class="btn  btn-sm btn-primary float-right"   data-toggle="modal" data-target="#listpodowaiting"
                           ...
                           <div class="card card-solid">
                                ...
                                <tbody>
                                    <?php  foreach ($listadd as $dt) : ?>
                                        <tr >
                                          ...
                                          <a id="delorderspodo" onclick="pododelorder()" href="javascript:void(0)" class="btn  btn-sm btn-danger float-center"   
                            ...
                            <button type="submit" class="btn  btn-lg btn-success float-left"    id="btn_permohonandana"
                            onclick="return confirm('Apakah Pemohonan Dana Sudah Sesuai ?');"  ><i class="far fa-credit-card"></i> Request Permohonan Dana
                            </button>
                            </form>
                                ...
                                <tbody>
                                    <?php  foreach ($podolist as $dt) : ?>
                                        <tr >
                                          ...
                                          <button id="addorderspodo" onclick="podoaddoder()" class="btn  btn-sm btn-info float-center"
                                          data-kode_po_do ="<?= $kode_podo; ?>"
                                          data-kode_parent ="<?= $dt['kode_order']; ?>"
                                          data-price = "<?= $dt['total_harga_beli']; ?>"                                        
                                         >
