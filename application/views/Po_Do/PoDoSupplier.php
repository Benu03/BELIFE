          ...
          <div class="col-12">
            ...
            <div class="card card-solid">
              <div class="card-body">
                  ...
                  <div class="col-4">
                    ...
                    <div class="card card-solid">
                      <div class="card-body">
                        ...
                        <button type="button" class="btn  btn-sm btn-primary float-right" data-toggle="modal" data-target="#listpodowaitingsup"><i class="fas fa-check-double"></i> Add Data</button>
                              ...
                              <tbody>
                                <?php foreach ($listadd_supplier as $dt) : ?>
                                  <tr>
                                    ...
                                    <td class="text-center" style="vertical-align:middle">
                                      <a id="delorderspodosup" onclick="pododelordersup()" href="javascript:void(0)" class="btn  btn-sm btn-danger float-center" data-id="<?= $dt['id']; ?>" data-kode_po_do="<?= $dt['kode_po_do']; ?>">
                ...
                <button type="submit" class="btn  btn-lg btn-success float-left" id="btn_permohonandana_supplier" onclick="return confirm('Apakah Data Request Sudah Sesuai ?');"><i class="far fa-credit-card"></i> Request PO & Supplier
                </button>
      </form>
