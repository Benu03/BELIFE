                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body table-responsive pad">
                            <table id="tborganization" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($dtOrganization as $org) : ?>
                                        <tr>
                                            <td width="30px"><?= $i++; ?></td>
                                                ...
                                                <div class="btn-group-vertical">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="location.href='<?= base_url('DataMaster/UpdateOrganization/' . Encrypt_url($org['id'])); ?>'">Update</a></li>
                                                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="confDelete('<?= base_url('DataMaster/DeleteOrganization/' . Encrypt_url($org['id'])); ?>')">Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </td>
...
<div class="modal fade" id="modal-add-data">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('DataMaster/AddOrganization'); ?>" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" id="organization_name" name="organization_name" placeholder="Enter Organization Name" required>
                    </div>
                    <div class="form-group">
