            ...
            <div class="row">
                <div class="col-6">
                    <div class="card card-success card-outline">
                        ...
                        <form action="<?= base_url('DataMaster/EditGeneral/' . Encrypt_url($general['id'])); ?>" method="POST" class="form-horizontal">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="code" class="col-sm-3 col-form-label">Kode</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="code" name="code" placeholder="Insert Kode Name" value="<?= $general['code']; ?>" requied>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="card-footer">
                                <a href="javascript:void(0)" onclick="location.href='<?= base_url('DataMaster/GeneralSetting'); ?>'" class="btn btn-sm btn-default">Cancel</a>
