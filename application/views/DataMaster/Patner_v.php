                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body table-responsive pad">
                            <table id="tbPatner" class="table table-bordered table-striped">
                                                ...
                                                <div class="btn-group-vertical">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="location.href='<?= base_url('DataMaster/Updatepatner/' . Encrypt_url($c['id'])); ?>'">Update</a></li>
                                                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="confDelete('<?= base_url('DataMaster/Deletepatner/' . Encrypt_url($c['id'])); ?>')">Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </td>
...
<div class="modal fade" id="modal-add-data">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('DataMaster/AddPatner'); ?>" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="patner_name">Patner Name</label>
                        <input type="text" class="form-control form-control-sm" id="patner_name" name="patner_name" placeholder="Enter Patner Name" required>
                    </div>
                    <div class="form-group">
