            ...
            <div class="row">
                <div class="col-6">
                    <div class="card card-success card-outline">
                        ...
                        <form action="<?= base_url('DataMaster/EditWorkLocation/' . Encrypt_url($dtLocation['id'])); ?>" method="POST" class="form-horizontal">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="location_name" class="col-sm-3 col-form-label">Title</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="location_name" name="location_name" placeholder="Insert Work Location" value="<?= $dtLocation['location_name']; ?>" requied>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="card-footer">
                                <a href="javascript:void(0)" onclick="location.href='<?= base_url('DataMaster/WorkLocation'); ?>'" class="btn btn-sm btn-default">Cancel</a>
