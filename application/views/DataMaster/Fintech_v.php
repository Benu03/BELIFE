                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body table-responsive pad">
                            <table id="tbFintech" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($fintech as $c) : ?>
                                        <tr>
                                            <td width="30px"><?= $i++; ?></td>
                                            <td><?= $c['fintech_name']; ?></td>
                                                ...
                                                <div class="btn-group-vertical">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="location.href='<?= base_url('DataMaster/Updatefintech/' . Encrypt_url($c['id'])); ?>'">Update</a></li>
                                                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="confDelete('<?= base_url('DataMaster/Deletefintech/' . Encrypt_url($c['id'])); ?>')">Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </td>
...
<div class="modal fade" id="modal-add-data">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('DataMaster/AddFintech'); ?>" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="fintech_name">Fintech Name</label>
                        <input type="text" class="form-control form-control-sm" id="fintech_name" name="fintech_name" placeholder="Enter Fintech Name" required>
                    </div>
                    <div class="form-group">
