            ...
            <div class="row">
                <div class="col-6">
                    <div class="card card-success card-outline">
                        ...
                        <form action="<?= base_url('DataMaster/Editpatner/' . Encrypt_url($patner['id'])); ?>" method="POST" class="form-horizontal">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="patner_name" class="col-sm-3 col-form-label">Title</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="patner_name" name="patner_name" placeholder="Insert patner Name" value="<?= $patner['patner_name']; ?>" requied>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="card-footer">
                                <a href="javascript:void(0)" onclick="location.href='<?= base_url('DataMaster/Patner'); ?>'" class="btn btn-sm btn-default">Cancel</a>
