            ...
            <div class="row">
                <div class="col-6">
                    <div class="card card-success card-outline">
                        ...
                        <form action="<?= base_url('DataMaster_Product/EditEkspedisi/' . Encrypt_url($dtEkspedisi['id'])); ?>" method="POST" class="form-horizontal">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="ekspedisi_name" class="col-sm-3 col-form-label">Ekspedisi Name</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="ekspedisi_name" name="ekspedisi_name" placeholder="Insert Ekspedisi Name" value="<?= $dtEkspedisi['ekspedisi_name']; ?>" requied>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="custom-control custom-radio">
                                            <?php if ($dtEkspedisi['is_active'] == '1') : ?>
                                        ...
                                        <div class="custom-control custom-radio">
                                            <?php if ($dtEkspedisi['is_active'] == '0') : ?>
                            ...
                            <div class="card-footer">
                                <a href="javascript:void(0)" onclick="location.href='<?= base_url('DataMaster_Product/Ekspedisi'); ?>'" class="btn btn-sm btn-default">Cancel</a>
