        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <?= form_error('ekspedisi_name', '<div class="alert alert-danger alert-dismissible text-sm"><button type="button" class="close text-sm-left" data-dismiss="alert" aria-hidden="true">&times;</button>', '</div>'); ?>
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body table-responsive pad">
                            <table id="tbekspedisi" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($dtEkspedisi as $org) : ?>
                                        <tr>
                                            <td width="30px"><?= $i++; ?></td>
                                            <td><?= $org['ekspedisi_name']; ?></td>
                                                ...
                                                <div class="btn-group-vertical">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="location.href='<?= base_url('DataMaster_Product/UpdateEkspedisi/' . Encrypt_url($org['id'])); ?>'">Update</a></li>
...
<div class="modal fade" id="modal-add-data">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('DataMaster_Product/AddEkspedisi'); ?>" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" id="ekspedisi_name" name="ekspedisi_name" placeholder="Enter ekspedisi Name" required>
                    </div>
                    <div class="form-group">
