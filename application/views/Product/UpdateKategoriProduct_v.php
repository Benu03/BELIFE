            ...
            <div class="row">
                <div class="col-6">
                    <div class="card card-success card-outline">
                        ...
                        <form action="<?= base_url('Product/EditKategoriProduct/' . Encrypt_url($kategori['id'])); ?>" method="POST" class="form-horizontal">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="kategori_name" class="col-sm-3 col-form-label">Title</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="kategori_name" name="kategori_name" placeholder="Insert Category Name" value="<?= $kategori['category_name']; ?>" requied>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="card-footer">
                                <a href="javascript:void(0)" onclick="location.href='<?= base_url('Product/DataKategoriProduct'); ?>'" class="btn btn-sm btn-default">Cancel</a>
