                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body table-responsive pad">
                            <table id="tbkategoriproduct" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($kategoriproduct as $org) : ?>
                                        <tr>
                                            <td width="30px"><?= $i++; ?></td>
                                            <td><?= $org['category_name']; ?></td>
...
<div class="modal fade" id="modal-add-data">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('Product/AddKategoriProduct'); ?>" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="kategori_product">Kategori Name</label>
                        <input type="text" class="form-control form-control-sm" id="kategori_product" name="kategori_product" placeholder="Enter Category Name" required>
                    </div>
                    <div class="form-group">
