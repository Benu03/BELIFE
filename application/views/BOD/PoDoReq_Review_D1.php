                            ...
                            <div class="row">
                                 ...
                                 <div class="card card-solid">
                                       ...
                                       <div class="form-group row">
                                        ...
                                        <a  href="javascript:void(0)" 
                                        onclick="location.href='<?= base_url('BOD/Approval_List/'); ?>'"
                                        class="btn  btn-sm btn-warning  btn-block text-center"    >
                                        ...
                                        <a  id="rejectpodoreq" onclick="rejectpodo()" href="javascript:void(0)"  class="btn  btn-sm btn-danger  btn-block text-center"  
                                          data-kode_po_do ="<?= $pododata['kode_po_do']; ?>"  >
