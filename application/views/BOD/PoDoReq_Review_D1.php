                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <form name="orderscustomerpodo" action="<?= base_url('BOD/PostPoDo_Review_Upd'); ?>" method="POST">
                                        ...
                                        <div class="card card-solid">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="noteapv" class="col-sm-5 col-form-label">Note </label>


                                                    <textarea class=" col-sm-7 form-control " style="overflow:auto;resize:none;font-size: 12px" id="noteapv" name="noteapv" normalizer_normalize="noteapv" rows="4" value="<?= set_value('noteapv'); ?>" required></textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        ...
                                                        <a href="javascript:void(0)" onclick="location.href='<?= base_url('BOD/Approval_List/'); ?>'" class="btn  btn-sm btn-warning  btn-block text-center">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <a id="rejectpodoreq" onclick="rejectpodo()" href="javascript:void(0)" class="btn  btn-sm btn-danger  btn-block text-center" data-kode_po_do="<?= $pododata['kode_po_do']; ?>">





                                                            <i class="fas fa-user-alt-slash"></i> Reject</a>
                                                    </div>


                                                    <div class="col-sm-4 text-center">
                                                        <button type="submit" class="btn  btn-sm btn-success btn-block text-center"><i class="fas fa-user-tie"></i> Approve </button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card card-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="tblpodoreview_d1" class="table table-bordered" style="font-size: 10px;">
